...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        ct: { red: '#D52B1E', 'red-dark': '#B10806', 'red-light': '#FEF2F2' },
        sidebar: { DEFAULT: '#1A1A1A', hover: '#2A2A2A', active: '#252525' },
        surface: { DEFAULT: '#FCFAF9', low: '#F6F3F2', card: '#FFFFFF', dim: '#EAE7E7' },
      },
      fontFamily: { sans: ['Public Sans', 'Inter', 'system-ui', '-apple-system', 'sans-serif'] },
      fontSize: {
